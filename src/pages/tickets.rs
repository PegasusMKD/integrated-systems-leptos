    ...
    let actions = move || {
        if actions {
            return view! {cx,
                <td class="px-6 py-4">
                    <div>
                        // <AddToCartButton id={"".to_string()} status refresh_trigger/>
                        <A href="edit"><button class="text-white mr-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit</button></A>
